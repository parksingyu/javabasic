...
public class ComparisonOperator {
	...
	public static void main(String[] args) {
		...
		boolean b = 10 < 20; // 비교 연산자의 연산결과는 boolean이다.
		// boolean b = true; //연산 결과
		System.out.println("10 < 20 = "+b); // 결과가 참이면 true
		b = 10 < 20 -15; //산술 연산자 먼저 계산 후 비교연산자 계산.
		System.out.println("10 < 20 -15 = " +b); //결과가 거짓이면 false
		
		b = 10 <= 10.0; // (double)10 <= 10.0
		//이항 연산자는 타입을 일치시킨 후 연산한다.
		System.out.println("10 <= 10.0 = " + b);
		b = 65 >= 'B'; // 65 >= (int)'B'
		System.out.println("65 >= 'B' = " + b);
		
		b = 10.0f == 10.0; // 같다
		System.out.println("10.0f == 10.0 = " + b ); // true
		b = 10.1f == 10.1; // 다르다
		System.out.println("10.1f == 10.1 = " + b ); // false
