...
public class Inheritance {
	...
	public static void main(String[] args) {
		 ...
		 * - 부모 클래스의 멤버와 자식 클래스의 멤버의 이름이 중복될 때 둘을 구분하기 위해 
		 * 
		 * << super() >>
		 * - 생성자에서 부모 클래스의 생성자를 호출하기 위해 사용한다.
		 * - 자식 클래스 생성자의 첫줄에는 super()가 있어야 한다. (1011수업내용중 : this 없는 생성자에 super가 들어간다)
		 * - 없으면 컴파일러가 자동으로 추가한다.
		 * 
		 * << 오버라이딩 >>
		...
		AccessModifier am = new AccessModifier(); //객체 생성
...
//		am.privateMethod();
		...
		//Singleton s = new Singleton();  //이런식으로 호출이 되지 않는다. 그래서!
